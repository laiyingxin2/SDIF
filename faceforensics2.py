...
from abstract_dataset2 import AbstractDataset
...
class FaceForensics(AbstractDataset):
    ...
    def __init__(self, cfg, seed=2022, transforms=None, transform=None, target_transform=None,mode='train'):
        # pre-check
...
if __name__ == '__main__':
    ...
    def run_dataloader(display_samples=False):
        ...
        for i, _ in enumerate(dataloader):
            path, targets,te = _
            image,image2,image3 = dataloader.dataset.load_item(path)
           # print(te)
